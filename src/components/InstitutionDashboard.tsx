            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-blue-600">+12 New</span>
                </div>
                  ...
                  >
                    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <button className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full hover:from-blue-600 hover:to-blue-700 transition-all shadow-md group-hover:shadow-lg">
                          Shortlist
                        </button>
                      </div>
                    </div>
                ...
                {activeJobs.map((job, index) => (
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <button className="text-blue-600 hover:text-blue-700 transition-colors flex items-center space-x-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-md border border-gray-100">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <button className="px-6 py-3 border-2 border-gray-200 text-gray-700 rounded-xl hover:border-blue-500 hover:text-blue-600 transition-colors flex items-center justify-center space-x-2">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-md border border-gray-100">
              ...
              <div className="space-y-4">
                {topMatches.map((candidate, index) => (
                  <div
                    key={index}
                    className="border border-gray-200 rounded-2xl p-6 hover:border-blue-300 hover:shadow-lg transition-all"
                  >
                    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
                      <ImageWithFallback
                        src={candidate.image}
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <button className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full hover:from-blue-600 hover:to-blue-700 transition-all shadow-md">
                          Contact
                        </button>
                      </div>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-md border-2 border-gray-200 hover:border-gray-300 transition-colors">
                ...
                <button className="w-full px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition-colors">
                  Start Free Trial
                </button>
              </div>

              {/* Annual Plan - Featured */}
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-8 shadow-xl transform scale-105 relative">
                <div className="absolute top-0 right-0 bg-blue-400 text-gray-900 px-4 py-1 rounded-bl-2xl rounded-tr-2xl text-sm">
                  Most Popular
                </div>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-blue-100 text-sm">Save ₹3,000 compared to monthly</p>
                </div>
                ...
                <button className="w-full px-6 py-3 bg-white text-blue-600 rounded-xl hover:bg-gray-100 transition-colors">
                  Subscribe Now
                </button>
              </div>
          ...
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <button className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-md">
                  Post Job
                </button>
              </div>
            </div>
