...
export function VerifyEmail({ email, phone, onBack, onVerify, onResend, selectedRole }: VerifyEmailProps) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white p-8 rounded-2xl shadow-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Enter the 6-digit code sent to your {email ? 'email' : 'phone'}</p>
          </div>
